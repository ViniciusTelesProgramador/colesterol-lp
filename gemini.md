...
- **Typography:** Grande contraste de escala seguindo o padrão de frase do Hero do preset. A primeira parte usando a fonte de heading sem serifa in negrito (bold sans). A segunda parte usando a fonte contendo serifa itálica massiva para o texto drama (diferença de tamanho de 3-5x).
