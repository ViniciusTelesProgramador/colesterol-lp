...
Você está estritamente proibido de escrever scripts em `tools/` até que:
    ...
    - O Esquema de Dados seja definido in `gemini.md`.
...
2. **Handshake:** Construa scripts mínimos em `tools/` para verificar se os serviços externos estão respondendo corretamente. Não prossiga para a lógica completa se o "Link" estiver quebrado.
